...
const faqs = [
  {
    ...
    a: "There's no account, no database, and no server processing your numbers. Once a split has real numbers in it, it's automatically saved to your browser's local storage on this device so you can find it later in your history. You can remove any saved split, or clear all of them, from the History page at any time.",
  },
  {
    q: 'Can I see past splits I have calculated?',
    a: "Yes. Splits are saved automatically as you calculate them and show up on the History page, listed by date, without any extra step on your part. Each one is stored only in your browser's local storage on this device. You can remove one split or clear all of them from that page at any time. Nothing is ever sent to a server.",
  },
  {
