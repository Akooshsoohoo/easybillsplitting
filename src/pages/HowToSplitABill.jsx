    ...
    >
      <Section title="Splitting evenly vs. splitting by item">
        <p>
          ...
          ordered. <strong>Splitting evenly</strong> — dividing the total by the number of people — works well
          when everyone ordered roughly the same amount: a group of friends who each got an entrée and a drink,
          for example. It's fast and nobody has to itemize anything.
        </p>
        <p>
          <strong>Splitting by item</strong> is fairer when orders were uneven — one person had an appetizer and
          a soda, another had three courses and two cocktails. Itemizing means each person pays for roughly what
          they actually consumed, plus a fair share of tax and tip, instead of subsidizing someone else's order.
        </p>
      </Section>
      ...
      <Section title="Handling shared items">
        <p>
          ...
          than assigning it to whoever happened to order it. In EasyBillSplitting's{' '}
      ...
      <Section title="Dividing tax and tip fairly">
        ...
        <p>
          ...
          treating service as something the whole table benefited from equally. Both are common — the choice
          is really a group preference, which is why the results screen lets you toggle between proportional
          and even tip splitting after the numbers are in.
        </p>
      </Section>

      <Section title="Applying discounts and coupons">
        <p>
          A discount that applies to the whole order (a happy-hour percentage off, a coupon) should come off the
          subtotal before tax and tip are calculated, allocated proportionally across everyone based on what they
          ordered. A discount that applies to one person only — a birthday freebie, a loyalty reward — should
          come off that person's final total instead. Keeping these two cases separate is what prevents a
          group discount from accidentally being absorbed by just one person, or a personal discount from
          quietly discounting everyone else's share too.
        </p>
      </Section>
      ...
      <Section title="A quick worked example">
        <p>
          ...
          $12 appetizer evenly. Item subtotals become A: $36 ($30 + $6 shared), B: $26 ($20 + $6 shared). With
          $5 tax and $10 tip split proportionally, A (about 58% of the subtotal) pays roughly $2.90 tax and $5.80
          tip, and B pays the rest — each paying tax and tip in proportion to what they actually ordered, not an
          even split that would overcharge the person who ordered less.
        </p>
      </Section>
